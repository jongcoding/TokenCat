...
| **내 취향대로 꾸미기**<br />계정별 색상, 그라데이션, 퍼센트 색상, 그래프 종류와 펫 움직임을 설정합니다. | **로컬 사용 분석**<br />최근 사용 변화량을 기반으로 활동도와 예상 소진 속도를 확인합니다. 프롬프트 내용은 기록하지 않습니다. |
...
설정을 열어도 작은 위젯의 크기나 배치는 바뀌지 않습니다. 일반, 대시보드, 계정, 디자인과 자동 업데이트를 별도 창에서 관리합니다.
...
```powershell
git tag -a v0.28.0 -m "TokenCat v0.28.0"
